def filter_intensity_kmerScore(
        numStnd, N, topNconvolutions, standardAutconvCleaned, thresholdValue, stand_aa_peak_pairs, polymerPeaks,
        intensities, generate_All_Kmers, realPepMass, e):
    ...
    if topkmer != "":
        ...
        roundedKmer = "-"
    return final_compound, highetScoredKmer[
        1], percentPolymerPeaks, percentProteinoPeaks, all_kmerScores, all_kmerFrequencies, all_kmerSequences, all_kmerMatches, roundedKmer
